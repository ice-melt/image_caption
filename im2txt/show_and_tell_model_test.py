...
class ShowAndTellModelTest(tf.test.TestCase):
  ...
  def _checkOutputs(self, expected_shapes, feed_dict=None):
    ...
    Args:
      expected_shapes: A dict mapping Tensor or Tensor name to expected output_2018110419
        shape.
  ...
  def testBuildForInference(self):
    ...
    # Test feeding a batch of inputs and LSTM states to get softmax output_2018110419 and
    # LSTM states.
