...
in the MSCOCO dataset is replicated ~5 times (once per caption) in the output_2018110419.
...
base_dir = "/home/ice-melt/PycharmProjects/im2txt"
tf.flags.DEFINE_string("train_image_file", base_dir+"/Flickr8k_text/Flickr_8k.trainImages.txt",
                       "Training image file.")
tf.flags.DEFINE_string("val_image_file", base_dir+"/Flickr8k_text/Flickr_8k.devImages.txt",
                       "Validation image file.")
tf.flags.DEFINE_string("test_image_file", base_dir+"/Flickr8k_text/Flickr_8k.testImages.txt",
                       "Testing image file.")
tf.flags.DEFINE_string("captions_file", base_dir+"/Flickr8k_text/Flickr8k.token.txt",
                       "Testing image file.")

tf.flags.DEFINE_string("output_dir", base_dir+"/data/output", "Output data directory.")
...
def _process_image_files(thread_index, ranges, name, images, decoder, vocab,
  ...
  Args:
    ...
    decoder: An ImageDecoder object.
    vocab: A Vocabulary object.
    num_shards: Integer number of shards for the output_2018110419 files.
  """
...
def main(unused_argv):
  ...
  assert _is_valid_num_shards(FLAGS.test_shards), (
      "Please make the FLAGS.num_threads commensurate with FLAGS.test_shards") #判断线程数是否有效
