...
tf.flags.DEFINE_string("input_file_pattern", "data/data/output4/val-?????-of-00008",
                       "File pattern of sharded TFRecord input files.")
tf.flags.DEFINE_string("checkpoint_dir", "output_2018110419/train",
                       "Directory containing model checkpoints.")
tf.flags.DEFINE_string("eval_dir", "output_2018110419/eval", "Directory to write event logs.")

tf.flags.DEFINE_integer("eval_interval_secs", 50,
                        "Interval between evaluation runs.")
tf.flags.DEFINE_integer("num_eval_examples", 10,
